...
private:
  ...
  void enemyposeCallback(const geometry_msgs::msg::PointStamped::SharedPtr enemypose);
  ...
  std::string enemypose_target_frame_;
  ...
  message_filters::Subscriber<geometry_msgs::msg::PointStamped> enemypose_sub_;
  ...
  std::shared_ptr<tf2_ros::MessageFilter<geometry_msgs::msg::PointStamped>> enemypose_tf2_filter_;
  ...
  rclcpp::Publisher<geometry_msgs::msg::PointStamped>::SharedPtr enemypose_pub_;
